...
public class SinglyLinkedList<E> {
    ...
    public int sum(SinglyLinkedList<E>list){
        Node<E>i=head;
        int s=0;
        while (i!=null){
    ...
    public int methodSize(SinglyLinkedList<E> list){
        Node<E>i=head;
        int s=0;
        while (i!=null){
            s++;
    ...
    public SinglyLinkedList<E> swap(SinglyLinkedList<E> list,int i,int j){
    ...
    public SinglyLinkedList<E>  append(SinglyLinkedList<E> L,SinglyLinkedList<E> M){
        if (!L.isEmpty()){
    ...
    public  SinglyLinkedList<E>concat (SinglyLinkedList<E> L,SinglyLinkedList<E>M){

        SinglyLinkedList<E>c1=new SinglyLinkedList<>();
    ...
    public boolean  equals(SinglyLinkedList<E> L,SinglyLinkedList<E> M){
        boolean f=false;
        Node<E>m=M.head;
        Node<E>l=L.head;
        if (L.size()==M.size()){
