...
public class DoublyLinkedList <E>{
    ...
    public DoublyLinkedList<E>  margin(DoublyLinkedList<E> L,DoublyLinkedList<E> M) {
    ...
    public DoublyLinkedList<E> swap(DoublyLinkedList<E> list,int i,int j){
    ...
    public DoublyLinkedList<E> clone(DoublyLinkedList<E>l){
        DoublyLinkedList<E>l1=new DoublyLinkedList<>();
        ...
        return l1;}
    public DoublyLinkedList<E> version(){
        DoublyLinkedList<E>l1=new DoublyLinkedList<>();
        Node<E> i=header.next;
        while (i!=tailer){
        ...
        return l1;}
    public Node<E> GetMiddle(DoublyLinkedList<E>l){
        ...
        return n;}
    public boolean  equals(DoublyLinkedList<E> L,DoublyLinkedList<E> M){
        boolean f=false;
    ...
    public E removeLast2NodeCon(DoublyLinkedList<E>list)  {
        Node<E>t=tailer;
